...
INSERT INTO COMPLIANCE_STANDARDS (id, code, label) VALUES
  (UUID_STRING(), 'OSHA_1910_178', 'OSHA 1910.178 – Powered Industrial Trucks'),
  (UUID_STRING(), 'DOT_49_CFR_396', 'DOT 49 CFR Part 396 – Vehicle Inspection & Maintenance'),
  (UUID_STRING(), 'FDA_FSMA', 'FDA FSMA – Food Safety Modernization Act'),
  (UUID_STRING(), 'AIB_INTL', 'AIB International – Food Safety Standards');
...
-- operator_warehouse + driver_delivery
...
-- fleet_admin
INSERT INTO ROLE_PERMISSIONS VALUES
  ('role-fleet', 'perm-09'), ('role-fleet', 'perm-10'), ('role-fleet', 'perm-11'),
  ('role-fleet', 'perm-12'), ('role-fleet', 'perm-15'), ('role-fleet', 'perm-16'),
  ('role-fleet', 'perm-17'), ('role-fleet', 'perm-18'), ('role-fleet', 'perm-19'),
  ('role-fleet', 'perm-20'), ('role-fleet', 'perm-08');
...
-- ── TEST USERS (passwords are bcrypt of 'Finspect2026!') ─────
-- Generate fresh hashes in production; these are for dev/QA only.
INSERT INTO USERS (id, email, password_hash, first_name, last_name,
    employee_id, preferred_lang, site_id) VALUES
  ('usr-01', 'ykesse@feedingwestchester.org',
   '$2b$12$placeholder_hash_ykesse', 'Yaw', 'Kesse', 'EMP001', 'en', 'site-elmsford-01'),
  ('usr-02', 'supervisor1@feedingwestchester.org',
   '$2b$12$placeholder_hash_super1', 'Maria', 'Lopez', 'EMP002', 'es', 'site-elmsford-01'),
  ('usr-03', 'operator1@feedingwestchester.org',
   '$2b$12$placeholder_hash_op1', 'James', 'Rivera', 'EMP003', 'en', 'site-elmsford-01'),
  ('usr-04', 'operator2@feedingwestchester.org',
   '$2b$12$placeholder_hash_op2', 'Ana', 'Gutierrez', 'EMP004', 'es', 'site-elmsford-01'),
  ('usr-05', 'operator3@feedingwestchester.org',
   '$2b$12$placeholder_hash_op3', 'Kevin', 'Chen', 'EMP005', 'en', 'site-elmsford-01'),
  ('usr-06', 'operator4@feedingwestchester.org',
   '$2b$12$placeholder_hash_op4', 'Rosa', 'Martinez', 'EMP006', 'es', 'site-elmsford-01'),
  ('usr-07', 'driver1@feedingwestchester.org',
   '$2b$12$placeholder_hash_drv1', 'Marcus', 'Brown', 'EMP007', 'en', 'site-elmsford-01'),
  ('usr-08', 'driver2@feedingwestchester.org',
   '$2b$12$placeholder_hash_drv2', 'Sofia', 'Reyes', 'EMP008', 'es', 'site-elmsford-01'),
  ('usr-09', 'safety@feedingwestchester.org',
   '$2b$12$placeholder_hash_sfty', 'David', 'Kim', 'EMP009', 'en', 'site-elmsford-01'),
  ('usr-10', 'fleetadmin@feedingwestchester.org',
   '$2b$12$placeholder_hash_fadm', 'Linda', 'Torres', 'EMP010', 'en', 'site-elmsford-01');
